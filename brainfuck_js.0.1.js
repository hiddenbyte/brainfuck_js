/* 	@Description Brainfuck interpreter for Javascript
 *	@Author hiddenbyte
 *	www.hiddenbyte.net
 */


var BrainfuckJS = new function()
{
	//enum Token
	var Token = {
		IncDataPointer : 0, 
	...
	var SingleCharCommand = function(token)
	{
	...
	//class WhileCommand
	var WhileCommand = function(commands)
	{
	...
	var ExecuteVisitor = function(executionContext)
	{
	...
	var ExecutionContext = function(std_out,std_in)
	{
